...
void polyvecl_freeze(polyvecl *v) {
  ...
  polyvecl_freeze_label19:for(i = 0; i < L; ++i)
    poly_freeze(&v->vec[i]);
}
...
void polyvecl_ntt(polyvecl *v) {
  ...
  polyvecl_ntt_label21:for(i = 0; i < L; ++i)
    poly_ntt(&v->vec[i]);
}
...
int polyvecl_chknorm(const polyvecl *v, uint32_t bound)  {
  ...
  polyvecl_chknorm_label22:for(i = 0; i < L; ++i)
...
void polyveck_freeze(polyveck *v)  {
  ...
  polyveck_freeze_label23:for(i = 0; i < K; ++i)
    poly_freeze(&v->vec[i]);
}
...
void polyveck_add(polyveck *w, const polyveck *u, const polyveck *v) {
  ...
  polyveck_add_label24:for(i = 0; i < K; ++i)
    poly_add(&w->vec[i], &u->vec[i], &v->vec[i]);
}
...
void polyveck_sub(polyveck *w, const polyveck *u, const polyveck *v) {
  ...
  polyveck_sub_label25:for(i = 0; i < K; ++i)
...
void polyveck_shiftl(polyveck *v) {
  ...
  polyveck_shiftl_label26:for(i = 0; i < K; ++i)
    poly_shiftl(&v->vec[i]);
}
...
void polyveck_ntt(polyveck *v) {
  ...
  polyveck_ntt_label27:for(i = 0; i < K; ++i)
    poly_ntt(&v->vec[i]);
}
...
void polyveck_invntt_montgomery(polyveck *v) {
  ...
  polyveck_invntt_montgomery_label28:for(i = 0; i < K; ++i)
...
int polyveck_chknorm(const polyveck *v, uint32_t bound) {
  ...
  polyveck_chknorm_label29:for(i = 0; i < K; ++i)
    if(poly_chknorm(&v->vec[i], bound))
      return 1;
...
void polyveck_power2round(polyveck *v1, polyveck *v0, const polyveck *v) {
  ...
  polyveck_power2round_label30:for(i = 0; i < K; ++i)
...
void polyveck_use_hint(polyveck *w, const polyveck *u, const polyveck *h) {
  ...
  polyveck_use_hint_label31:for(i = 0; i < K; ++i)
