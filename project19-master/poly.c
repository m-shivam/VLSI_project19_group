...
void poly_shiftl(poly *a) {
  ...
  poly_shiftl_label9:for(i = 0; i < N; ++i)
    a->coeffs[i] <<= D;
...
#else
  polyeta_pack_label12:for(i = 0; i < N/2; ++i) {
...
#else
  polyeta_unpack_label15:for(i = 0; i < N/2; ++i) {
...
#error "polyt1_pack() assumes D == 14"
  ...
  polyt1_pack_label16:for(i = 0; i < N/8; ++i) {
...
void polyt0_pack(unsigned char *r, const poly *a) {
  ...
  polyt0_pack_label13:for(i = 0; i < N/4; ++i) {
...
void polyt0_unpack(poly *r, const unsigned char *a) {
  ...
  polyt0_unpack_label14:for(i = 0; i < N/4; ++i) {
...
#error "polyz_pack() assumes GAMMA1 <= 2^{19}"
  ...
  polyz_pack_label17:for(i = 0; i < N/2; ++i) {
    /* Map to {0,...,2*GAMMA1 - 2} */
...
void polyw1_pack(unsigned char *r, const poly *a) {
  ...
  polyw1_pack_label18:for(i = 0; i < N/2; ++i)
