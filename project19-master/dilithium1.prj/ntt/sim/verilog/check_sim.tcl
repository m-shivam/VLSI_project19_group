# ==============================================================
# File generated on Wed Feb 05 16:14:05 EST 2020
...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         ...
         "c.ntt.autotvin_ntt_count.dat"
         "c.ntt.autotvin_montgomery_count.dat"
         "c.ntt.autotvout_p.dat"
         "c.ntt.autotvout_ntt_count.dat"
         "c.ntt.autotvout_montgomery_count.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         ...
         "rtl.ntt.autotvout_ntt_count.dat"
         "rtl.ntt.autotvout_montgomery_count.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
